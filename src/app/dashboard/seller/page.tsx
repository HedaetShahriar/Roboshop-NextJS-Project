...
import { Clock, Truck, CheckCircle2, XCircle, TriangleAlert, DollarSign, TrendingUp, Receipt, LucideIcon } from "lucide-react";
...
export default async function SellerDashboardHome() {
  ...
  const fmtCurrency = (n: number): string => formatBDT(n);
