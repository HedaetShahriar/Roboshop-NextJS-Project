...
interface BrandingPreviewProps {
  logoInputId: string;
  footerLogoInputId: string;
  faviconInputId: string;
  initialLogo?: string;
...
export default function BrandingPreview({
  ...
  useEffect(() => {
    const logoEl = document.getElementById(logoInputId) as HTMLInputElement | null;
    const footEl = document.getElementById(footerLogoInputId) as HTMLInputElement | null;
    const favEl = document.getElementById(faviconInputId) as HTMLInputElement | null;

    function onLogo() {
      setLogo(logoEl?.value || "");
    }
    function onFoot() {
      setFooterLogo(footEl?.value || "");
    }
    function onFav() {
      setFavicon(favEl?.value || "");
    }
