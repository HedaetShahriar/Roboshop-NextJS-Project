...
import { LayoutDashboard, Package, MessageSquare, PlusSquare, Bike, Shield, Users, Settings, PanelLeftOpen, PanelLeftClose, type LucideIcon } from "lucide-react";
import { usePathname } from "next/navigation";
import DashboardNavbar from "./DashboardNavbar";
import { useSession } from "next-auth/react";
import { useRouter } from "next/navigation";

type Role = "admin" | "rider" | "seller";
...
const resolveIcon = (navItem: NavItem): LucideIcon => {
  if (navItem?.icon) {
...
export default function DashboardShell({ role, nav, children }: DashboardShellProps) {
  ...
  const pretty = (seg: string) => (seg || 'dashboard')
    .replace(/-/g, ' ')
