...
interface AddressModalButtonProps {
  address?: AddressData | null;
  label?: string;
}

export default function AddressModalButton({ address, label = 'View' }: AddressModalButtonProps) {
        ...
        <div className="fixed inset-0 z-[60]">
          ...
          <div className="absolute left-1/2 top-1/2 w-[92vw] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-lg border bg-white shadow-xl">
            ...
            <div className="px-4 py-3 border-t flex justify-end">
              <Button size="sm" onClick={handleCloseClick}>Close</Button>
            </div>
          </div>
        </div>
      )}
