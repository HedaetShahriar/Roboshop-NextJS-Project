...
export type Scope = 'selected' | 'page' | 'filtered';
...
export default function BulkActionsPanel({ 
  ...
  const [action, setAction] = useState<BulkAction>('stockInc');
        ...
        <div className="grid gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              value={action}
              onChange={(e: ChangeEvent<HTMLSelectElement>) => setAction(e.target.value as BulkAction)}
              form={formId}
  ...
  return (
    <div className="flex flex-col gap-2 rounded-md border bg-zinc-50 p-2">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <select name="bulkAction" className="h-9 rounded border px-2 text-xs" value={action} onChange={(e) => setAction(e.target.value as BulkAction)} form={formId}>
          <optgroup label="Stock">
