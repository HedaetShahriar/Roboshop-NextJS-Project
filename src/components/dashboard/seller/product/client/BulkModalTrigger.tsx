...
interface BulkModalTriggerProps {
  formId?: string;
  scope?: "selected" | "page" | "filtered";
  pageCount?: number;
  total?: number;
}

export default function BulkModalTrigger({ formId, scope, pageCount, total }: BulkModalTriggerProps) {
