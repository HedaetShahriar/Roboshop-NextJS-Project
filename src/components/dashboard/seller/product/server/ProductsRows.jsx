import ProductsMobileCard from "../client/ProductsMobileCard";
import ProductsTableRow from "../client/ProductsTableRow";
...
import { adjustStock, updatePricing, clearDiscountSingle } from "./actions";
    ...
    <>
      ...
      <div className="sm:hidden space-y-2 overflow-auto">
        {products.map((p) => {
          ...
          return (
            <ProductsMobileCard key={id} p={p} id={id} onAdjustStockAction={adjustStock} onUpdatePricingAction={updatePricing} onClearDiscountAction={clearDiscountSingle} />
          );
        })}
      </div>
            ...
            {products.map((p, i) => {
              ...
              return (
                <ProductsTableRow
                  ...
                  onAdjustStockAction={adjustStock}
                  onUpdatePricingAction={updatePricing}
                  onClearDiscountAction={clearDiscountSingle}
                />
              );
            })}
          </tbody>
